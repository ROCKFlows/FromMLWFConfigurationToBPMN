...
public class ArangoConfigurationFeature implements GraphConfigurationFeature<ArangoStandardKnowledgeTask,
        ArangoTaskVersion> {
    ...
    public ArangoConfigurationFeature(String automatic, String manual,
                                      ArangoStandardKnowledgeTask task, ArangoTaskVersion version) {
