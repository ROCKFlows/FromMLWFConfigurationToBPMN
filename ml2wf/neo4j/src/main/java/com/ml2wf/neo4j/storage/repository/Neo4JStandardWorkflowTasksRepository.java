...
@Repository
public interface Neo4JStandardWorkflowTasksRepository extends ReactiveNeo4jRepository<Neo4JStandardWorkflowTask, Long>,
    ...
    @Query("""
            ...
            """)
    Mono<Neo4JStandardWorkflowTask> findOneByNameAndVersionName(String taskName, String versionName);
}
