...
@Repository
public interface Neo4JStandardKnowledgeTasksRepository extends ReactiveNeo4jRepository<Neo4JStandardKnowledgeTask, Long>,
    ...
    @Query("""
            ...
            """)
    Mono<Neo4JStandardKnowledgeTask> findOneByNameAndVersionName(String taskName, String versionName);
}
