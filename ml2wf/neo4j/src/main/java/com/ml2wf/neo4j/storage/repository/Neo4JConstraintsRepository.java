...
@Repository
public interface Neo4JConstraintsRepository extends ReactiveNeo4jRepository<Neo4JConstraintOperand, Long>,
    ...
    @Query("""
            ...
            """)
    Flux<Neo4JConstraintOperand> findAllByTypeAndVersionName(String constraintType, String versionName);
}
