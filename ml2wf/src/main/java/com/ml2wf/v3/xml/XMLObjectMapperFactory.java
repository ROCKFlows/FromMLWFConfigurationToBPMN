...
import com.ml2wf.v3.xml.mixins.constraints.operands.VariableOperandMixin;
import com.ml2wf.v3.xml.mixins.constraints.operands.serializer.VariableOperandSerializer;
import com.ml2wf.v3.xml.mixins.constraints.operators.AbstractOperatorMixin;
import com.ml2wf.v3.xml.mixins.constraints.operators.serializer.AbstractOperatorSerializer;
import com.ml2wf.v3.xml.mixins.tree.custom.featuremodel.FMMixin;
import com.ml2wf.v3.xml.mixins.tree.custom.featuremodel.FMRuleMixin;
import com.ml2wf.v3.xml.mixins.tree.custom.featuremodel.FMStructureMixin;
import com.ml2wf.v3.xml.mixins.tree.custom.featuremodel.FMTaskMixin;
import com.ml2wf.v3.xml.mixins.tree.custom.featuremodel.serializers.FeatureModelRuleSerializer;
import com.ml2wf.v3.xml.mixins.tree.custom.featuremodel.serializers.FeatureModelTaskSerializer;
import com.ml2wf.v3.xml.mixins.workflow.custom.bpmn.BPMNWFMixin;
import com.ml2wf.v3.xml.mixins.workflow.custom.bpmn.BPMNWFDocumentationMixin;
import com.ml2wf.v3.xml.mixins.workflow.custom.bpmn.BPMNWFTaskMixin;
import com.ml2wf.v3.xml.mixins.workflow.custom.bpmn.BPMNProcessMixin;
import com.ml2wf.v3.xml.mixins.workflow.custom.bpmn.BPMNProcessSequenceFlowMixin;
